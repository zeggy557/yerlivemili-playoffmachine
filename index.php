    		...
    		<div class="container" id="selectioncontainer">
    			<div class="columns" id="matchweeks">
  					<div class="column" id="matchweek12">
						...
						<div class="buttons divisional" id="w12m4">
				  			<button class="button is-primary is-light team team1" id="giselewin1" data-teamname="gisele">Gisele'in Askerleri</button>
				 			<button class="button is-primary is-light team team2" id="evliwin1" data-teamname="evli">Evli Mayfields</button>
						</div>
						<div class="buttons divisional" id="w12m5">
				  			<button class="button is-primary is-light team team1" id="deliyurekwin1" data-teamname="deliyurek">DeliYürekMirOglusu</button>
				 			<button class="button is-primary is-light team team2" id="blackeagleswin1" data-teamname="blackeagles">Wisconsin Blackeagles</button>
						</div>
						<div class="buttons divisional" id="w12m6">
				  			<button class="button is-primary is-light team team1" id="killerswin1" data-teamname="killers">The Cereal Killers</button>
				 			<button class="button is-primary is-light team team2" id="karsiyakawin1" data-teamname="karsiyaka">Karşıyaka 35,5ers</button>
						</div>
  					</div>
  					<div class="column" id="matchweek13">
   						<div class="buttons" id="w13m1">
				  			<button class="button is-primary is-light team team1" id="deliyurekwin1" data-teamname="deliyurek">DeliYürekMirOglusu</button>
				 			<button class="button is-primary is-light team team2" id="ayranciwin1" data-teamname="ayranci">South Ayrancı Phrygians</button>
						</div>
						<div class="buttons" id="w13m2">
				  			<button class="button is-primary is-light team team1" id="killerswin1" data-teamname="killers">The Cereal Killers</button>
				 			<button class="button is-primary is-light team team2" id="giselewin1" data-teamname="gisele">Gisele'in Askerleri</button>
						</div>
						<div class="buttons divisional" id="w13m3">
				  			<button class="button is-primary is-light team team1" id="luolwin1" data-teamname="luol">Luol Dengim Değilsin</button>
				 			<button class="button is-primary is-light team team2" id="karsiyakawin1" data-teamname="karsiyaka">Karşıyaka 35,5ers</button>
						</div>
						<div class="buttons divisional" id="w13m4">
				  			<button class="button is-primary is-light team team1" id="donkeyswin1" data-teamname="donkeys">Billionaire Donkeys</button>
				 			<button class="button is-primary is-light team team2" id="goztepewin1" data-teamname="crows">Göztepe Crows</button>
						</div>
						<div class="buttons divisional" id="w13m5">
				  			<button class="button is-primary is-light team team1" id="nokiawin1" data-teamname="nokia">İnce Nokia Chargers</button>
				 			<button class="button is-primary is-light team team2" id="evliwin1" data-teamname="evli">Evli Mayfields</button>
						</div>
						<div class="buttons divisional" id="w13m6">
				  			<button class="button is-primary is-light team team1" id="blackeagleswin1" data-teamname="blackeagles">Wisconsin Blackeagles</button>
